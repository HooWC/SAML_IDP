...
return [
    ...
    'sp' => [
        ...
        'aHR0cDovLzEyNy4wLjAuMTo4MDAwL2FjY291bnQvaG9tZQ==' => [
            'destination' => 'http://www.saml-ip-v1.localhost/account/home',
            'logout' => 'http://www.saml-ip-v1.localhost/logout',

            // SP specific certificate
            'certificate' => '',
